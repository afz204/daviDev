...
<br>
        <form id="SoftCopy" methods="post" data-parsley-validate="">
            <div class="row">
        ...
        <table id="TableSoftCopy" class="table table-bordered  <?=$device['device']=='MOBILE' ? 'table-responsive' : ''?> table-condensed table-hover" style="text-transform: capitalize;">
            ...
            <tr style="text-transform: lowercase;">
                ...
                <th scope="col" width="10%">tanggal kirim email</th>
