                            ...
                            <?php while ($row = $payCharge->fetch(PDO::FETCH_LAZY)){ 
                                ...
                                <tr style="text-transform: lowercase;">
                                    ...
                                    <td>
                                        ...
                                        <div class="btn-group">
                                          <button style="text-transform: uppercase; font-size: 10px; font-weight: 500;" type="button" class="btn btn-sm btn-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" <?=$row['status'] != '' ? 'disabled' : '' ?> >
                                            remarks
                                          </button>
