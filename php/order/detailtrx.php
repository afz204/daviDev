<?php 
    ...
    'LEFT JOIN transaction_details ON transaction_details.id_trx = transaction.transactionID LEFT JOIN customer ON customer.ID = transaction.CustomerID LEFT JOIN corporates ON corporates.CorporateUniqueID = transaction.CustomerID LEFT JOIN payment ON payment.ID = transaction.paymentID', "WHERE transaction.transactionID = '". $trx ."'");
    $product = [];
    $data = [];
    ...
    <div class="row justify-content-center card-body">
        <div id="imagesProduct" class="col-12 col-md-4 col-lg-4">
            ...
            <div class="card-body">
                <?php foreach($product as $prod) { ?>
                    ...
                    <div class="desc" style="padding: 1%; background-color: #ebebeb; border-radius: 4px; margin-bottom: 5%;">
        ...
        <div id="detailProduct" class="col-12 col-md-8 col-lg-8">
            ...
            <div class="card-header">
                    ...
                    <button type="button" class="btn btn-outline-danger"><span class="fa fa-print"></span> DO</button>
                    <button type="button" class="btn btn-outline-success"><span class="fa fa-print"></span> Card Messages</button>
                    </div>
                </div>
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="status" value="<?=Date('d M Y', strtotime($data['delivery_date']))?>" autocomplete="text" placeholder="" readonly>
                                <div class="invalid-feedback">
                                Valid last name is required.
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="provinsi" value="<?=$data['delivery_time']?>" autocomplete="text" placeholder=""  readonly>
                                <div class="invalid-feedback">
                                Valid first name is required.
                                </div>
                            </div>
